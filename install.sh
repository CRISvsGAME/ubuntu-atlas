...
PKG_NAME="mongodb-atlas-cli"
REP_NAME="mongodb"
GPG_LINK="https://www.mongodb.org/static/pgp/server-8.0.asc"
GPG_PATH="/usr/share/keyrings/$REP_NAME.gpg"
REP_LINK="https://repo.mongodb.org/apt/ubuntu"
REP_PATH="/etc/apt/sources.list.d/$REP_NAME.list"
REP_INFO="deb [arch=$ARCH signed-by=$GPG_PATH] $REP_LINK noble/mongodb-org/8.0 multiverse"
